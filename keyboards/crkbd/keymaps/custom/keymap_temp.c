...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x6_3_ex2(KC_GRV, KC_B, KC_F, KC_L, KC_K, KC_Z, KC_VOLU, KC_MPLY, KC_X, KC_G, KC_O, KC_U, KC_COMM, KC_EQL, LCTL(KC_V), KC_N, KC_S, KC_H, KC_T, KC_M, KC_VOLD, KC_MNXT, KC_Y, KC_C, KC_A, KC_E, KC_I, KC_TAB, KC_BSLS, LSFT_T(KC_P), LGUI_T(KC_V), LCTL_T(KC_J), LALT_T(KC_D), KC_Q, KC_QUOT, RALT_T(KC_W), RCTL_T(KC_SCLN), RGUI_T(KC_SLSH), RSFT_T(KC_DOT), KC_MINS, KC_BSPC, KC_R, OSL(4), OSL(5), KC_SPC, KC_ENT),
