...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x6_3_ex2(KC_GRV, KC_B, KC_F, KC_L, KC_K, KC_Q, KC_VOLU, KC_MPLY, KC_P, KC_G, KC_O, KC_U, KC_COMM, KC_EQL, KC_TAB, LSFT_T(KC_N), LT(7,KC_S), LCTL_T(KC_H), LALT_T(KC_T), LGUI_T(KC_M), KC_VOLD, KC_PSCR, RGUI_T(KC_Y), RALT_T(KC_C), RCTL_T(KC_A), LT(7,KC_E), RSFT_T(KC_I), KC_ESC, KC_BSLS, KC_X, KC_V, KC_J, KC_D, KC_Z, KC_QUOT, KC_W, KC_SCLN, KC_SLSH, KC_DOT, KC_MINS, LCTL(KC_V), LT(4,KC_R), KC_BSPC, KC_ENT, LT(5,KC_SPC), LCTL(KC_Z)),
    [1] = LAYOUT_split_3x6_3_ex2(KC_GRV, KC_B, KC_F, KC_L, KC_K, KC_Q, DF(0), KC_MPLY, KC_P, KC_G, KC_O, KC_U, KC_COMM, KC_EQL, KC_TAB, KC_N, KC_S, KC_H, KC_T, KC_M, OS_LSFT, KC_PSCR, KC_Y, KC_C, KC_A, KC_E, KC_I, KC_ESC, KC_BSLS, KC_X, KC_V, KC_J, KC_D, KC_Z, KC_QUOT, KC_W, KC_SCLN, KC_SLSH, KC_DOT, KC_MINS, LCTL(KC_V), KC_R, KC_BSPC, KC_ENT, KC_SPC, LCTL(KC_Z)),
    [2] = LAYOUT_split_3x6_3_ex2(KC_GRV, KC_Q, KC_E, KC_R, KC_T, KC_Y, DF(0), KC_NO, KC_U, KC_I, KC_O, KC_P, KC_COMM, KC_EQL, KC_TAB, KC_A, KC_S, KC_W, KC_D, KC_F, OS_LSFT, KC_NO, KC_L, KC_G, KC_H, KC_J, KC_K, KC_ESC, KC_BSLS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_QUOT, KC_N, KC_M, KC_SLSH, KC_DOT, KC_MINS, KC_1, KC_ENT, KC_BSPC, KC_4, KC_SPC, KC_2),
    ...
    [7] = LAYOUT_split_3x6_3_ex2(LGUI(KC_GRV), QK_MACRO_16, QK_MACRO_17, QK_MACRO_18, QK_MACRO_19, LGUI(KC_Z), KC_NO, KC_NO, QK_MACRO_15, QK_MACRO_0, QK_MACRO_1, QK_MACRO_2, QK_MACRO_3, RGUI(KC_EQL), LGUI(KC_BSLS), QK_MACRO_20, QK_MACRO_21, QK_MACRO_22, QK_MACRO_23, LGUI(KC_M), KC_NO, KC_NO, QK_MACRO_14, QK_MACRO_4, QK_MACRO_5, QK_MACRO_6, QK_MACRO_7, KC_NO, LGUI(KC_TAB), QK_MACRO_24, QK_MACRO_25, QK_MACRO_26, QK_MACRO_27, LGUI(KC_Q), QK_MACRO_13, QK_MACRO_8, QK_MACRO_9, QK_MACRO_10, QK_MACRO_11, RGUI(KC_MINS), KC_NO, QK_MACRO_28, KC_NO, QK_MACRO_29, QK_MACRO_12, KC_NO)
};
