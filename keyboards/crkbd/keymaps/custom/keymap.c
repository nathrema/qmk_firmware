...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [5] = LAYOUT_split_3x6_3_ex2(KC_ESC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, DF(1), MO(6), KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_ESC, KC_TAB, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_F11, DF(0), DF(2), KC_F12, KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_BSPC, KC_TRNS, KC_F7, KC_F8, KC_F9, KC_F10, KC_F6, KC_F5, KC_F1, KC_F2, KC_F3, KC_F4, KC_TRNS, KC_DEL, KC_R, OS_LSFT, OS_RSFT, KC_SPC, KC_TRNS),
