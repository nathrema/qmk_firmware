...
tap_dance_action_t tap_dance_actions[] = {
    [TD_COPY_PSTE] = ACTION_TAP_DANCE_DOUBLE(KC_PSTE, KC_COPY),
};
...
// };
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x6_3_ex2(KC_GRV, KC_B, KC_F, KC_L, KC_K, KC_Z, KC_VOLU, KC_MPLY, KC_X, KC_G, KC_O, KC_U, KC_COMM, KC_EQL, TD(TD_COPY_PSTE), KC_N, KC_S, KC_H, KC_T, KC_M, KC_VOLD, KC_MNXT, KC_Y, KC_C, KC_A, KC_E, KC_I, KC_TAB, KC_BSLS, LSFT_T(KC_P), LGUI_T(KC_V), LCTL_T(KC_J), LALT_T(KC_D), KC_Q, KC_QUOT, RALT_T(KC_W), RCTL_T(KC_SCLN), RGUI_T(KC_SLSH), RSFT_T(KC_DOT), KC_MINS, KC_BSPC, KC_R, OSL(4), OSL(5), KC_SPC, KC_ENT),
    ...
    [4] = LAYOUT_split_3x6_3_ex2(KC_ESC, KC_CIRC, KC_PERC, KC_AT, KC_EXLM, KC_TILD, DF(1), MO(6), KC_GRV, KC_NO, KC_HASH, KC_DLR, KC_ASTR, KC_ESC, KC_WBAK, KC_LT, KC_LBRC, KC_LCBR, KC_LPRN, KC_AMPR, DF(0), DF(2), KC_PIPE, KC_RPRN, KC_RCBR, KC_RBRC, KC_GT, KC_WFWD, KC_PIPE, KC_7, KC_8, KC_9, KC_0, KC_6, KC_5, KC_1, KC_2, KC_3, KC_4, KC_UNDS, KC_TRNS, KC_R, KC_TRNS, KC_TRNS, KC_SPC, KC_TRNS),
