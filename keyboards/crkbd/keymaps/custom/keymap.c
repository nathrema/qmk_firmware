...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x6_3_ex2(KC_GRV, KC_B, KC_F, KC_L, KC_K, KC_Z, KC_VOLU, KC_MPLY, KC_X, KC_G, KC_O, KC_U, KC_COMM, KC_EQL, KC_TAB, KC_N, KC_S, KC_H, KC_T, KC_M, KC_VOLD, KC_MNXT, KC_Y, KC_C, KC_A, KC_E, KC_I, QK_REP, KC_BSLS, LSFT_T(KC_P), LT(7,KC_V), LCTL_T(KC_J), LALT_T(KC_D), LGUI_T(KC_Q), RGUI_T(KC_QUOT), RALT_T(KC_W), RCTL_T(KC_SCLN), LT(7,KC_SLSH), RSFT_T(KC_DOT), KC_MINS, TD(TD_COPY_PSTE), KC_R, LT(4,KC_BSPC), LT(5,KC_ENT), KC_SPC, TD(TD_UNDO_AGIN)),
    ...
    [7] = LAYOUT_split_3x6_3_ex2(LGUI(KC_GRV), QK_MACRO_19, QK_MACRO_18, QK_MACRO_17, QK_MACRO_16, LGUI(KC_Z), KC_NO, KC_NO, QK_MACRO_15, QK_MACRO_0, QK_MACRO_1, QK_MACRO_2, QK_MACRO_3, RGUI(KC_EQL), LGUI(KC_TAB), QK_MACRO_23, QK_MACRO_22, QK_MACRO_21, QK_MACRO_20, LGUI(KC_M), KC_NO, KC_NO, QK_MACRO_14, QK_MACRO_4, QK_MACRO_5, QK_MACRO_6, QK_MACRO_7, KC_NO, LGUI(KC_BSLS), QK_MACRO_27, QK_MACRO_26, QK_MACRO_25, QK_MACRO_24, LGUI(KC_Q), QK_MACRO_13, QK_MACRO_8, QK_MACRO_9, QK_MACRO_10, QK_MACRO_11, RGUI(KC_MINS), KC_NO, QK_MACRO_28, KC_NO, QK_MACRO_29, QK_MACRO_12, KC_NO)
};
